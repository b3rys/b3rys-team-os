...
# 모델 명시 (2026-05-30 OWNER 결정): CLI default 가 아직 4.7 이라 명시 필요. env 로 override 가능.
...
#   단순 재실행 시 이 가드가 no-op이라 복구가 안 되던 함정 방지(하네스 근본, OWNER 2026-07-02).
