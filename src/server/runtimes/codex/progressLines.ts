 ...
 *   편집 최소 간격 1.5초(★우리는 2초 — 제품 결정: 2026-08-18★) · 미리보기 40자 · 연속 중복은 (×N) 으로 접기 ·
 ...
 *  hermes 실구현은 1.5초다. 우리는 2초로 둔다(제품 결정: 2026-08-18) — 줄이 빠르게 늘 때
...
/**
 * 작업 줄 아이콘 — 줄마다 돌려 쓴다.
 * ★같은 그림이 세로로 반복되면 줄 수를 눈으로 못 센다★(제품 결정: 2026-08-18).
...
export function renderBubble(header: string, lines: ProgressLine[]): string {
  ...
  //   여기서 교체한다. 쌓지 않으므로 화면이 그것으로 차지 않는다(제품 결정: 2026-08-18).
  //   실제 작업은 그 아래에 계속 쌓인다.
