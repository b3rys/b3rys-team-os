...
// ★"이 스레드의 방이 어디냐" — 이 질문의 정본은 여기 하나다.★ (OWNER 2026-07-14 "기본부터 다지자")
//
 ...
 * (`tg--EXAMPLE_TELEGRAM_GROUP_ID` → `-EXAMPLE_TELEGRAM_GROUP_ID`. 앞의 `-` 는 chat_id 의 일부다 — 잘라내면 안 된다.)
 */
...
// 주입문 문맥 라벨 — 그룹방이면 "단톡방" 명시(참고용=상황파악용). 간결 (OWNER 2026-07-16).
