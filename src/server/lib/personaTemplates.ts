...
function sectionTeamShare(runtime: string, agentId?: string): string {
  if (runtime === "claude_channel") {
    return [
      ...
      "- Team skill catalog = the `docs/B3OS_SKILLS.md` index. Use a skill that fits the work (claude auto-discovers SKILL.md).",
