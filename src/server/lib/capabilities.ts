 ...
 *                        = "누가 볼지 애매하면 이 사람이 받아서 OWNER 께 문의한다"(OWNER 2026-07-10 결정: member가 아니라 빌).
 ...
 *
 * 안전망(member+하네스 리뷰 2026-06-20): coordinator 가 0개면 라우팅 fallback 들이 [] 를 반환해 메시지가
 ...
 *
 * OWNER 2026-07-10 결정: "오너 애매한 메시지는 member(coordinator)가 받지 말고 member이 받아서 OWNER 께 문의(ask owner)한다."
