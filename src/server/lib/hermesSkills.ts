...
/**
 * ★hermes 프로필의 팀 스킬 = 정본 심링크. 사본을 만들지 않는다.★ (OWNER 2026-07-14)
 *
 * ═══ 왜 ═══
 ...
 * 사본 = 심링크가 아닌 실제 디렉토리. 옛 이름(owner-team-inbox)도 사본으로 본다.
 */
export function findHermesSkillCopies(
  ...
  for (const profile of profiles) {
    ...
    for (const name of [TEAM_INBOX_SKILL, "owner-team-inbox"]) {
