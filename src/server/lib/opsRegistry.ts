// opsRegistry — 잡/기능을 한 레지스트리로 모아 *조건부 on/off* 관리(P1, OWNER 2026-06-28 설계: Bill+Codex+Steve).
//
// 설계 핵심(Codex 리뷰):
...
export interface OpsEntry {
  ...
  type: "job" | "feature";
  title: string;
  scope: "public" | "internal";   // 퍼블릭 패키지에 실릴지(OWNER: 설정도 live↔public 분리)
  default_desired: boolean;        // 사용자 미설정 시 기본 desired (OWNER: 안전·유익은 기본 ON)
...
// OWNER 스코핑: public = capture/router·onoff·칸반·learning·auto-heal·continuation·read-slash / internal = deploy·digest·approve·b3os야간.
