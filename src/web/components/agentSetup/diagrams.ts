...
return { owners: coord ? [coord] : [] };                       // 그 외 → coordinator, 없으면 ask_gd`,
        pick(
  ...
  return `
    <div class="rounded-xl border border-surface-3 bg-surface-0 p-4">
      ...
      <svg viewBox="0 0 1120 430" class="h-auto w-full" role="img" aria-label="communication principles timeline">
        ...
        <text x="421" y="102" text-anchor="middle" fill="#bae6fd" font-size="12">${pick("버스 · 그룹방 · GD 1:1", "Bus · Group · GD 1:1")}</text>
