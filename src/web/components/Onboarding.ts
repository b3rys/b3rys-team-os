    ...
    overlay.innerHTML = `
      <div class="onb-card">
        ...
        <ol class="onb-steps">
          ...
          ${STEP("3", pick("첫 대화로 일 맡기기", "Assign work in your first chat"), pick("팀원에게 말 걸듯 일을 맡기면 b3os가 진행을 남깁니다. 그룹방을 쓸 땐 System OP에서 op 봇 privacy mode OFF(또는 admin 승격)도 확인하세요.", "Hand off work as if talking to a member, and b3os keeps a record of the progress. For a group room, also check System OP: op bot privacy mode OFF (or promote it to admin)."))}
        </ol>
        <div class="onb-cta">
