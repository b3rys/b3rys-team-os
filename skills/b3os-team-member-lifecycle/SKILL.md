...
- Team group mention aliases: verify official bot handle and local aliases separately. Example: Hermes requires both `@example_hermes_bot` and alias patterns like `@헤르메스`, `@헤르`, `@hermes`.
