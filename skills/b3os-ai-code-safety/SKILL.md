...
The smell is the signal; the refactor is the response. The two OWNER called out first:
...
- b3rys lessons: data-source bug + behavior-verify (`feedback_verify_actual_behavior_not_tsc`, 2026-07-06); lifecycle + refactoring framing (OWNER 2026-07-06).
