...
| Code comments banned, because 99% of agent comments record history ("the lead said never do X") instead of explaining code. | Adapt | We keep "why" comments; history goes to commits/docs, not code. A check for history-style comments is a candidate, not a rule. |
