...
3. **HTML 렌더**(확인 시) — `scripts/render.sh <md> [out.html] [제목]` → 아이폰 반응형 HTML+SVG(자체완결, 다크 테마).
4. **포털 게시**(확인 시) — `scripts/publish.sh --title "T" --author maintainer --summary "S" --md a.md --html a.html` → team-collab `reports/`에 복사 + 등록 → **<dashboard-url>/reports** 목록에 바로 뜸.
...
```html
<svg viewBox="0 0 400 60"><g font-size="11" fill="#9aa7b4">
  <text x="0" y="22">솔로</text><rect x="80" y="12" width="40" height="13" fill="#22c55e" rx="2"/><text x="124" y="22" fill="#e6edf3">58s</text>
  <text x="0" y="42">harness</text><rect x="80" y="32" width="160" height="13" fill="#f97316" rx="2"/><text x="244" y="42" fill="#e6edf3">92s</text>
</g></svg>
```
색 토큰: 솔로/좋음=`#22c55e`(초록), harness/주의=`#f97316`(주황), 경고=`#ef4444`(빨강), 강조=`#fbbf24`(노랑), 링크/제목=`#38bdf8`(파랑).
