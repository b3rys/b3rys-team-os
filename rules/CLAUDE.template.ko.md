...
- 팀 skill catalog: `~/Development/b3rys-team-os/docs/B3OS_SKILLS.md`
- teammate 메시지/리뷰 요청: `team-collab/skills/b3os-team-inbox/scripts/send.sh` 또는 해당 skill의 `reply.sh`/`thread.sh`를 사용한다.
