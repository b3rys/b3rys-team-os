...
- If a runtime cannot auto-discover team skills, use `rules/B3OS_SKILLS.md` and the linked `skills/*/SKILL.md` files directly.
...
- Canonical skill index: `rules/B3OS_SKILLS.md`.
