...
- **Anything that stays in the repository or goes outside — code, comments, commit messages, PRs, issues, external docs — carries facts and causes only.** No retrospective narrative, no self-criticism, no quoting what a person said. Attribute a change to the requirement or the measurement, not to who asked. That material belongs in memory and `SHARED.md`. Detail: `skills/b3os-github-workflow/SKILL.md`.
